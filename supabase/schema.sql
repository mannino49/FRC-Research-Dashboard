...
create table if not exists public.ai_outputs (
  ...
  person_id text references public.people(id),
  output_type text not null check (output_type in ('abstract', 'outline', 'collaborator_suggestions', 'project_direction', 'handoff_brief', 'status_summary', 'next_action', 'stalled_waiting_check', 'followup_email', 'progress_note', 'metadata_audit', 'manuscript_status', 'next_paragraph', 'manuscript_question', 'reference_suggestions')),
